...
/** @brief Sent after Nuance SpeechAnywhere has finished processing all audio data
	@since 1.0
 
	Sent to the receiver whenever the user stops speaking and Nuance SpeechAnywhere has finished
...
/** @brief Sent after Nuance SpeechAnyhwere has recognized all utterances started by the end user in a 
	...
	Sent to the receiver when Nuance SpeechAnywhere has finished working on all utterances started for 
